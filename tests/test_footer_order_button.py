...
class TestRegisterFooterButton:
    ...
    def test_register_using_footer_order_button(self, driver):
        ...
        rent_page.order_black_scooter_using_footer_order_button()
...
#   (есть баги)
    ...
    def test_check_delivery_date_next_month(self, driver):
        main_page = MainPage(driver)
        register_page = RegisterForm(driver)
        rent_page = RentPage(driver)
        check_status = CheckStatusPage(driver)
        ...
        assert check_status.check_delivery_date_next_month()
    ...
    def test_check_duration_7days(self, driver):
        main_page = MainPage(driver)
        register_page = RegisterForm(driver)
        rent_page = RentPage(driver)
        check_status = CheckStatusPage(driver)
        ...
        assert check_status.check_duration_7days()
    ...
    def test_check_scooter_color(self, driver):
        ...
        assert check_status.check_black_color()
    ...
    def test_check_comment(self, driver):
        ...
        assert check_status.check_comment()
